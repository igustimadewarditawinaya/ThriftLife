...
<br><br><br>	
    ...
    <form action="" method="post" autocomplete="off">
    	<div class="col s2">
    		<br>
    		<a href="index.php?halaman=tambahproduk" class="btn green waves-effect waves-dark ">Tambah Data</a>
    	</div>
      <div class="col s8"> 
    ...
    while($row = mysqli_fetch_array($SqlQuery)){   
     ?>
		<tr>
			...
			<td>
				<a href="index.php?halaman=hapusproduk&id=<?php echo $row['id_produk']; ?>" class="btn red waves-effect waves-light">hapus</a>
				<a href="index.php?halaman=ubahproduk&id=<?php echo $row['id_produk']; ?>" class="btn orange waves-effect waves-light">ubah</a>
