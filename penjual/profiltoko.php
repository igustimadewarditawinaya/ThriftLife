 		...
 		<div class="row">
 			...
 			<div class="col s6 m6 l6 xl6">
 				<div class="carousel carousel-slider">
 					<a class="carousel-item" href="#one!"><img src="../assets/img/homepage/Program Studi S1 Informatika.png"></a>
 					<a class="carousel-item" href="#two!"><img src="../assets/img/homepage/FIK.png"></a>
 				</div>
 			</div>
 			<div class="col s6 m6 l6 xl6">
